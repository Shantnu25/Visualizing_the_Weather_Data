...
# Generating a line chart that visualizes the readings in the months
...
# Calling the function line_chart() with the appropriate parameters.
line_chart(weather_df,"Month","Temp (C)")  


# Now let's perform the univariate analysis of categorical features.
# Calling the "function plot_categorical_columns()" with appropriate parameters.
plot_categorical_columns(weather_df)


# Let's plot the Univariate analysis of Numerical columns.
# Calling the function "plot_cont()" with the appropriate parameters to plot distplot
plot_cont(weather_df,"distplot")


# Calling the function "plot_cont()" with the appropriate parameters to plot boxplot
plot_cont(weather_df,"boxplot")

# Groupby the data by Weather and plot the graph of the mean visibility during different weathers. Calling the function group_values to plot the graph.
